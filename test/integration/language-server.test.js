...
let calc = new Calculator(10);
  ...
  describe('AST and Utility Integration', () => {
    it('should properly validate AST with required methods', () => {
      expect(typeof testSourceFile.getPositionOfLineAndCharacter).toBe('function');
    });
  ...
  describe('Symbol and Binding Integration', () => {
    ...
    it('should handle function scope and parameters', () => {
      const functionCode = 'function test(a, b) { let sum = a + b; return sum; } let result = test(1, 2);';
      const sourceFile = ts.createSourceFile(
        'function-scope.js',
        functionCode,
        ts.ScriptTarget.ES2015,
