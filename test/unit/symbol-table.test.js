...
describe('SymbolTable Module', () => {
  ...
  beforeEach(() => {
    ...
    testSymbol1 = Symbol.create('function1', { kind: ts.SyntaxKind.FunctionDeclaration });
    testSymbol2 = Symbol.create('variable1', { kind: ts.SyntaxKind.VariableDeclaration });
  });
  ...
  describe('insert', () => {
    ...
    it('should overwrite existing symbol with same name', () => {
      // Arrange
      const anotherSymbol = Symbol.create('function1', { kind: ts.SyntaxKind.ClassDeclaration });
      symbolTable.insert(testSymbol1);
  ...
  describe('SymbolTable.copy', () => {
    ...
    it('should create a deep copy of symbol table', () => {
      ...
      expect(Object.keys(copiedSymbols)).toHaveLength(Object.keys(originalSymbols).length);
