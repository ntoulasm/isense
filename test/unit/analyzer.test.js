...
describe('Analyzer Module', () => {
  ...
  beforeEach(() => {
    ...
    mockSourceFile.statements = [mockVariableDeclaration, mockFunctionDeclaration];
  });
  ...
  describe('Analyzer.analyze', () => {
    ...
    it('should handle empty source file and produce empty diagnostics', () => {
      ...
      expect(Array.isArray(emptySourceFile.analyzeDiagnostics)).toBe(true);
    ...
    it('should handle source file with parse errors gracefully', () => {
      // Arrange
      const parseError = { category: ts.DiagnosticCategory.Error, messageText: 'Syntax error' };
  ...
  describe('Analyzer type inference', () => {
    it('should process numeric literals correctly', () => {
      ...
      expect(Array.isArray(sourceWithNumber.analyzeDiagnostics)).toBe(true);
    ...
    it('should process string literals correctly', () => {
      ...
      expect(Array.isArray(sourceWithString.analyzeDiagnostics)).toBe(true);
    ...
    it('should process boolean literals correctly', () => {
      ...
      expect(Array.isArray(sourceWithBooleans.analyzeDiagnostics)).toBe(true);
  ...
  describe('Analyzer function analysis', () => {
    ...
    it('should analyze function calls correctly', () => {
      ...
      const functionCall = {
        ...
        expression: { kind: ts.SyntaxKind.Identifier, text: 'testFunction' },
        arguments: [
  ...
  describe('Analyzer variable analysis', () => {
    ...
    it('should handle variable declarations without initializers correctly', () => {
      ...
      const variableWithoutInit = {
        kind: ts.SyntaxKind.VariableDeclaration,
        name: { text: 'uninitializedVar', kind: ts.SyntaxKind.Identifier },
        parent: {
          kind: ts.SyntaxKind.VariableDeclarationList,
          flags: 0
        }
        ...
        properties: [
          {
            ...
            name: { text: 'prop1' },
            initializer: { kind: ts.SyntaxKind.NumericLiteral, text: '42' }
          },
          {
            kind: ts.SyntaxKind.PropertyAssignment,
            name: { text: 'prop2' },
            initializer: { kind: ts.SyntaxKind.StringLiteral, text: '"value"' }
          }
        ]
      };
