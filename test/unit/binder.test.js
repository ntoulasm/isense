...
describe('Binder Module', () => {
  ...
  describe('Binder.bindFunctionScopedDeclarations', () => {
    it('should handle null body gracefully', () => {
      // Act & Assert
      expect(() => Binder.bindFunctionScopedDeclarations(null)).not.toThrow();
    });

    it('should handle undefined body gracefully', () => {
      // Act & Assert
      expect(() => Binder.bindFunctionScopedDeclarations(undefined)).not.toThrow();
    });
    ...
    it('should handle function body with statements', () => {
      ...
      mockFunctionBody.statements = [
        variableDecl,
        nestedFunction
      ];

      // Act & Assert
      expect(() => Binder.bindFunctionScopedDeclarations(mockFunctionBody)).not.toThrow();
    });
  });
  ...
  describe('Binder.bindBlockScopedDeclarations', () => {
    ...
    it('should handle block with various statement types', () => {
      ...
      // Act & Assert
      expect(() => Binder.bindBlockScopedDeclarations(mockBlockStatement)).not.toThrow();
    });
  ...
  describe('Binder error handling', () => {
    ...
    it('should handle circular references in AST', () => {
      ...
      // Act & Assert
      expect(() => Binder.bindFunctionScopedDeclarations(node1)).not.toThrow();
    });
  });
});
