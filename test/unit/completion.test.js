...
jest.mock('../../server/src/utility/type-carrier', () => ({
    ...
    evaluate: jest
        .fn()
        .mockReturnValue([{ type: 'string', hasValue: true, value: 'mock' }]),
}));
...
describe('Completion Service', () => {
    ...
    describe('Completion.onCompletion', () => {
        ...
        it('should provide property completions for object with dot trigger', () => {
            ...
            const mockPropertyAccessNode = {
                ...
                expression: {
                    ...
                    text: 'obj',
                    carrier: {
                        // Mock type carrier for property evaluation
                        type: 'object',
                        properties: {
                            getSymbols: () => ({
                                property1: {
            ...
            expect(mockUtility.getPropertySymbols).toHaveBeenCalledWith(
                mockPropertyAccessNode
            );
        ...
        it('should provide identifier completions when no trigger character', () => {
            ...
            expect(Ast.findVisibleSymbols).toHaveBeenCalledWith(
                mockIdentifierNode
            );
        ...
        it('should provide property completions when focused on property access name', () => {
            ...
            // Assert
            expect(Ast.isNameOfPropertyAccessExpression).toHaveBeenCalledWith(
                mockPropertyName
            );
            expect(mockUtility.getPropertySymbols).toHaveBeenCalledWith(
                mockPropertyName.parent
            );
    ...
    describe('Completion.onCompletionResolve', () => {
        it('should add detail from data signature', () => {
            ...
            const completionItem = {
                ...
                data: {
                    signature:
                        'function testFunction(a: number, b: string): void',
                },
            };
    ...
    describe('Completion edge cases', () => {
        ...
        it('should handle unknown syntax kinds', () => {
            ...
            // Act & Assert
            expect(() =>
                Completion.onCompletion(mockTextDocumentPositionParams)
            ).not.toThrow();
        });
