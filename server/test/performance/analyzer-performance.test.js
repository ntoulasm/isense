...
describe('Performance Tests', () => {
    ...
    describe('Analyzer Performance', () => {
        it(
            'should analyze large files within reasonable time',
            done => {
                // Arrange
        ...
        it(
            'should handle many function calls without stack overflow',
            done => {
                // Arrange
                const functionCalls = [];
                functionCalls.push(
                    'function recursive(n) { return n <= 0 ? 0 : recursive(n - 1) + 1; }'
                );

                for (let i = 0; i < 1000; i++) {
                    functionCalls.push(
                        `const call${i} = recursive(${i % 10});`
                    );
                }
    ...
    describe('Completion Performance', () => {
      ...
      `;
        ...
        it(
            'should provide completions for large objects quickly',
            done => {
                // Arrange
    ...
    describe('Memory Usage Tests', () => {
        it(
            'should not cause memory leaks with repeated analysis',
            done => {
                // Arrange
                const testCode = `
    ...
    describe('Stress Tests', () => {
        ...
        it(
            'should handle extreme nesting levels gracefully',
            done => {
